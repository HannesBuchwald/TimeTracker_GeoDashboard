...
var mapboxSat = L.tileLayer("https://{s}.tiles.mapbox.com/v4/mapbox.streets-satellite/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiaGFubmVzYnVjaHdhbGQwMSIsImEiOiJjajc0cjFxemQwYjJrMndtdGR2aDlzbXNtIn0.VAcXcGXZ0iaAN5Lb8oVKMw", {
  maxZoom: 19,
  subdomains: ["a", "b", "c", "d"],
  attribution: 'Basemap <a href="https://www.mapbox.com/about/maps/" target="_blank">© Mapbox © OpenStreetMap</a>'
});
...
$.getJSON(config.geojson, function (data) {
  ...
  featureLayer.addData(o);

  var test = o.features;
  if(test.length == 0) {
    //  alert( "You have " + test.length + " geodates in your database" );
    swal('Error - No GeoData available!', 'Please track your position first and retry', 'error');
  }
